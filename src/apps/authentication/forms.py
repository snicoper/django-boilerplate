...
class RegisterUserForm(forms.ModelForm):
    ...
    def clean_username(self):
        ...
        if username.lower() in auth_settings.AUTH_USERNAME_BLACKLIST:
            raise forms.ValidationError(ugettext('Nombre de usuario no valido'))
        return username
...
class UserEmailUpdateForm(forms.Form):
    ...
    def clean(self):
        """Comprueba que new_email y re_new_email son iguales y que no este
        registrado ya en la db.
        """
